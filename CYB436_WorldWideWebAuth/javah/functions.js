...
/* -----   Function List   ------- */
		...
		/* Create function to Calculate R1 Total */
		function calcR1() {
			/* Define variables for total */
			var totalr1, i1tot, i2tot, i3tot, i4tot;
			/* Set values of variables */
			i1tot = parseFloat(document.getElementById('r3').value);
			i2tot = parseFloat(document.getElementById('r7').value);
			i3tot = parseFloat(document.getElementById('r11').value);
			i4tot = parseFloat(document.getElementById('r15').value);		
			/* Check item count */
			if (m < 3) {
				alert("You don't have enough items!");
					}
			else {
				totalr1 = i1tot + i2tot + i3tot + i4tot;
				document.getElementById('r1tot').value = ("$" + totalr1);
				}
			}
			
		/* Create function to Calculate R2 Total */
		function calcR2() {
			/* Define variables for total */
			var totalr2, it1tot, it2tot;
			/* Set values of variables */
			it1tot = parseFloat(document.getElementById('w3').value);
			it2tot = parseFloat(document.getElementById('w7').value);		
			/* Check item count */
			if (n < 1) {
				alert("You don't have enough items!");
					}
			else {
				totalr2 = it1tot + it2tot;
				document.getElementById('r2tot').value = ("$" + totalr2);
				}
			}			
